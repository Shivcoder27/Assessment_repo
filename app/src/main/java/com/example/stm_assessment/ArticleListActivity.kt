...
class ArticleListActivity : AppCompatActivity() {
    ...
    private fun getSampleArticles(): List<Article> {
        return listOf(
            Article(
                ...
                "Researchers announce a major step forward in artificial general intelligence.",
            ...
            Article(
                2,
                "Global Markets Rebound After Slow Start",
                "Stock markets recover as tech leads the way.",
                ...
                "2025-05-07T14:45:00Z",
                "Finance",
                "https://example.com/images/market-rebound.jpg",
                78,
                5
            ),
            Article(
                3,
                "Championship Final Ends in Dramatic Tie",
                "A nail-biting finish leaves fans stunned in the international cricket final.",
                ...
                "2025-05-06T20:15:00Z",
                "Sports",
                "https://example.com/images/cricket-final.jpg",
                204,
                32
            )
        )
    ...
    inner class ArticleAdapter(private val articles: List<Article>) :
        ...
        override fun onBindViewHolder(holder: ArticleViewHolder, position: Int) {
            ...
            holder.authorTextView.text = article.author.name
        ...
        inner class ArticleViewHolder(view: android.view.View) : RecyclerView.ViewHolder(view) {
            ...
            val summaryTextView: TextView = view.findViewById(R.id.article_summary)
            val contentTextView: TextView = view.findViewById(R.id.article_content)
            val authorTextView: TextView = view.findViewById(R.id.article_author)
            val publishedAtTextView: TextView = view.findViewById(R.id.article_published_at)
